	...
	<script type="text/javascript">
		...
		$(function(){
			$("#userDataGrid").datagrid({
				...
				columns:[ 
				    [
					     {field:'sysuserId',title:'ID',width:120},
					     {field:'sysuserLoginname',title:'账户名',width:120},
					     {field:'sysuserName',title:'真实名',width:120},
					     {field:'sysuserUpdatedatetime',title:'创建时间',width:120},
					     {field:'sysuserCreatedatetime',title:'修改时间',width:120},
				    ]    
				] 
			});
		});
